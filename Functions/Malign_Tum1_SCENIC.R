...
so = readRDS("~/Manuscript/Data/Seurat_rds/ccbr1119_malign_tum1.rds")

so@meta.data$custom_cluster <- paste("SubClus",so@meta.data$SCT_snn_res.0.4,sep="")
...
myDatasetTitle <- "CCBR_1119_Tum1_SCENIC" # choose a name for your analysis
data(defaultDbNames)
